...
const makeRouter = async (routerInput: IBaseAppInput): Promise<Router> => {
  ...
  router.post(
    '/:id/return',
    await makeController({
      controller: controller.returnDocumentController,
      dbConnection: routerInput.dbConnection,
    }),
  )
  router.post(
  ...
  router.post(
    '/:id/return-approve/:returnId',
    await makeController({
      controller: controller.returnApproveDocumentController,
      dbConnection: routerInput.dbConnection,
    }),
  )
  router.post(
    '/:id/return-reject/:returnId',
    await makeController({
      controller: controller.returnRejectDocumentController,
      dbConnection: routerInput.dbConnection,
    }),
  )
  router.post(
