...
export interface IRetrieveTodoDocumentOutput {
  data: IRetrieveDocumentOutput[]
  pagination: IPagination
}
export interface IRetrieveTodoDocumentRepository {
  handle(query: IQuery): Promise<IRetrieveTodoDocumentOutput>
}

export class RetrieveAllDocumentRepository implements IRetrieveTodoDocumentRepository {
  constructor(
    public database: IDatabase,
    public options?: Record<string, unknown>,
  ) {}

  async handle(query: IQuery): Promise<IRetrieveTodoDocumentOutput> {
